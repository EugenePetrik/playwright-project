...
import { LIGHTHOUSE_MOBILE_LINKS } from '../../test_data/lighthouse';

LIGHTHOUSE_MOBILE_LINKS.forEach(({ testName, url, performance, accessibility, bestPractices, seo, isMobile, reportName }) => {
  test.describe('Mobile Lighthouse Verification', () => {
